 ...
 return (
   <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
     <div className="w-full max-w-md bg-zinc-900 p-8 rounded-xl shadow-xl">
       <h2 className="text-4xl font-bold text-center mb-2 text-cyan-300">MockMate</h2>
       <p className="text-zinc-400 text-center mb-8">Sign in to access your account</p>


       <form onSubmit={handleSubmit}>
         <div className="mb-4">
           <label htmlFor="username" className="block mb-2 text-sm text-cyan-200">Username</label>
           <input
             type="text"
             id="username"
             name="username"
             ...
             className="w-full px-4 py-2 rounded-md bg-zinc-800 text-white border border-zinc-700 focus:border-cyan-400 focus:outline-none"
           />
         </div>


         <div className="mb-4">
           <label htmlFor="password" className="block mb-2 text-sm text-cyan-200">Password</label>
           <input
             type="password"
             id="password"
             name="password"
         ...
         <button
           type="submit"
           className="w-full bg-cyan-500 hover:bg-cyan-400 text-black font-semibold py-2 rounded transition duration-200"
         >
           Sign in
         </button>


         <p className="text-center my-3 text-zinc-400">Or</p>


         <button
           onClick={() => signIn('google')}
           type="button"
           className="w-full flex items-center justify-center border border-cyan-500 hover:bg-orange-500 hover:text-white text-cyan-300 py-2 rounded transition duration-200"
         >
           <span className="mr-3 bg-white p-1 rounded">
